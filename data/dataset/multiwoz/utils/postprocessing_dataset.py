...
if __name__ == '__main__':
    ...
    if not os.path.exists(os.path.join(cfg.data_prefix, 'multi-woz-fine-processed')):
        os.mkdir(os.path.join(cfg.data_prefix, 'multi-woz-fine-processed'))
    ...
    out_f = os.path.join(cfg.data_prefix, 'multi-woz-fine-processed', 'multiwoz-fine-processed-train.json')
    ...
    out_f = os.path.join(cfg.data_prefix, 'multi-woz-fine-processed', 'multiwoz-fine-processed-dev.json')
    with open(out_f, 'w') as outfile:
    ...
    out_f = os.path.join(cfg.data_prefix, 'multi-woz-fine-processed', 'multiwoz-fine-processed-test.json')
    with open(out_f, 'w') as outfile:
